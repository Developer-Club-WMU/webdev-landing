...
const sectionTitleClass = "text-2xl font-bold [letter-spacing:-.05em] md:text-3xl lg:text-5xl";

const sectionParagraphClass = "text mt-5 mb-10 text-base leading-relaxed font-normal opacity-90 sm:text-lg md:text-xl";
...
const GoalCard: React.FC<GoalCardProps> = ({
    ...
    <div
        className={`flex flex-col justify-between rounded-2xl border ${borderColor} ${bgColor} p-5 text-white shadow-md w-80`}
    >
        ...
        <ul className="mt-5 mb-10 space-y-4 text-lg font-normal text-white opacity-90 lg:text-xl">
            {audienceList.map(({ dot, text }, idx) => (
                <li key={idx} className="flex items-center gap-3">
                    ...
                    <span className="text-text dark:text-text-inverted">{text}</span>
                </li>
            ))}
        </ul>
    </>
...
const AboutUsPage = () => {
    ...
    return (
        <div className="info-page">
            <div className="text-text dark:text-text-inverted flex flex-col gap-3 text-4xl font-black md:text-6xl lg:text-7xl xl:text-8xl">
                <h1 className="title">
                    <span>About The </span>
                    <span
                ...
                <div className="">
                    ...
                    <div className="mt-5 mb-10 flex flex-wrap items-stretch gap-6 md:flex-row md:justify-center md:gap-4">
                        {goals.map((goal, idx) => (
