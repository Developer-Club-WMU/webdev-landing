      ...
      <div className="w-full flex flex-col max-w-xl mx-auto p-4">
        ...
        <div className="bg-white/50 dark:bg-black/40 p-6 rounded-xl shadow-xl space-y-4 text-left">
          {questions.slice(0, questions.length - 1).map((q, index) => (
            <div key={index} className="border-b border-gray-500/20 pb-4 last:border-b-0 last:pb-0">
              <p className="text-lg font-medium text-gray-800 dark:text-gray-200 mb-1">{q}</p>
