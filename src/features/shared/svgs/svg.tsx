...
export interface SvgProps extends React.SVGProps<SVGSVGElement> {
  ...
  newTab?: boolean;
  /**
   * width/height (px or rem)
   */
  size?: number | string;

  /**
   * accessible label; if absent → aria-hidden
   */
  ariaLabel?: string;

  /**
   * adds <title> for tooltips/AT
   */
  title?: string;
...
function SvgShell({
  ...
  const node = (
    <svg
      ...
      fill="currentColor"      // use text-* colors
...
export const SVG_TIKTOK = (props: SvgProps) => (
  <SvgShell {...props} className={"h-12 w-12 text-black dark:text-white"}>
